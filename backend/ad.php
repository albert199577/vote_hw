<h2 class="text-center font-weight-bold my-5">廣告管理</h2>
        ...
        <div class="col-md-9">
            ...
            <table class="table text-center">
                ...
                foreach ($rows as $row) {
                    ...
                    echo "</a>";
                    echo "<td>";
                    echo "<button class='btn btn-success'>修改</button>";
                    echo "</td>";
                    echo "<td>";
                    echo "<a href='?do=edit_ad&id={$row['id']}'>";
                    echo "<button class='btn btn-info'>重新上傳</button>";
                    echo "</td>";
                    echo "<td>";
